...
type LoginRequest struct {
	...
	Password      string                 `protobuf:"bytes,2,opt,name=password,proto3" json:"password,omitempty"`         // Password fo the user to login
...
const file_sso_sso_proto_rawDesc = "" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB\x19Z\x17electronic.sso.v1;ssov1b\x06proto3"
